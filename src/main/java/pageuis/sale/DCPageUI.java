package pageuis.sale;
	...
	public class DCPageUI {
		
		public static final String BTN_CHECK_CIC = "//button[@id='form[btnGetS37Report]']";
		public static final String BTN_CHECK_REPORT_S37 = "//button[@id='form[btnViewS37Report]']";
		...
		public static final String IMG_S37 = "//span[@class='size']";
