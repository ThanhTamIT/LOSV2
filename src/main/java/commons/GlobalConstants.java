...
public class GlobalConstants {
	...
	public static final long LONG_TIMEOUT1 = 60;
	public static final long LONG_TIMEOUT2 = 120;
	public static final String URL_SALE = "http://dev-dsa.shbfinance.com.vn/sysshbf/en/neoclassic/login/login";
	public static final String URL_MASTER = "http://dev-los.shbfinance.com.vn/sysshbf/en/neoclassic/login/login";
