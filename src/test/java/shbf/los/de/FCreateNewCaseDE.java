...
//        deNewcasePageObject.clickToAppCodeExpect("DS223812310040021749");
        deNewcasePageObject.clickToAppCodeExpect(APP_CODE);
        ...
        ExtentTestManager.getTest().log(Status.INFO, "Step 17: Chose disbursement method");
        deNewcasePageObject.scrollToElement(DEPageUI.DRD_DISBURSEMENT_CHANNEL);
        deNewcasePageObject.selectItemInDefaultDropdown(DEPageUI.DRD_DISBURSEMENT_CHANNEL, "Nhận tiền mặt tại địa điểm đại lý chi hộ");

        ExtentTestManager.getTest().log(Status.INFO, "Step 18: Chose de decision");
        ...
        ExtentTestManager.getTest().log(Status.INFO, "Step 19: Click button Completed");
